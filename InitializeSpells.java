...
public class InitializeSpells {
    ...
    void initallspellsListView(ListView<String> allspellslistView) {
        initallSpells();
        for (int i = 0; i < numOfSpells; i++) {
    ...
    void initalldescrListView(ListView<String> allspellslistView) {
        for (int i = 0; i < numOfSpells; i++) {
    ...
    ObservableList<String> ClassandLevelListView(int c, int l) {
